...
void insertarAlFinal(struct Lista & tad, struct Cliente cliente) {
...
//    while ((recorrido != nullptr) and (recorrido->cliente.dni != elemento)) {
//        recorrido = recorrido->siguiente;
//    }
//    return recorrido;
//}
//
Cliente retornaCabeza(const struct Lista & tad){
    return tad.cabeza->cliente;
}
